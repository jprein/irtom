...
export default async ({ currentSlide, previousSlide }) => {
	// Name of slide
	const slidePrefix = 's-sofalsebelief-a';
	...
	const girlDigging = document.getElementById(`${slidePrefix}-girl-digging`) as SvgInHtml;
	const girlStanding = document.getElementById(`${slidePrefix}-girl-standing`) as SvgInHtml;
	const girlHiding = document.getElementById(`${slidePrefix}-girl-hiding`) as SvgInHtml;
	const boyDigging = document.getElementById(`${slidePrefix}-boy-digging`) as SvgInHtml;
	const boyStanding = document.getElementById(`${slidePrefix}-boy-standing`) as SvgInHtml;
	const treasure = document.getElementById(`${slidePrefix}-treasure`) as SvgInHtml;
