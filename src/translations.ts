export const translations = {
	...
	intro: {
		german: `<p class="intro-text">
			...
			Zwischen den Fragen taucht ein roter Pfeil auf. Falls du eine kurze Pause brauchst, ist das ein guter Moment. Tippe dafür auf das Pause-Zeichen, um die Kamera kurz anzuhalten. Um danach weiterzuspielen und die Aufnahme wieder zu starten, tippst du einfach auf den Weiter-Knopf. <br> <br> 
